# Historique des versions — archive 0.2.0 → 0.11.0

> **Archive.** Ce fichier couvre les versions 0.2.0 à 0.11.0 (2025-10-19 →
> 2025-11-15). Les symboles, fichiers et mécanismes qui y sont cités décrivent le
> code **tel qu'il était à chaque version** : beaucoup n'existent plus. Un
> changelog ne se réécrit pas — le contenu est laissé intact.
>
> Pour les versions suivantes, voir [CHANGELOG.md](CHANGELOG.md).
